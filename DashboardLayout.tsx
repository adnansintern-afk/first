...
export default function DashboardLayout() {
  ...
  const navigation = [
    ...
    { name: 'Settings', href: '/dashboard/settings', icon: Settings }, // Explicit Settings Page
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] flex font-sans overflow-hidden">
      ...
      >
        ...
        <div className="h-24 flex items-center justify-between px-6 border-b border-gray-50 flex-shrink-0 relative">
          {!sidebarCollapsed ? (
            ...
            <div className="w-full flex flex-col items-center gap-2">
               ...
               {/* Toggle Button Cleanly Overlaying */}
               <button 
        ...
        {/* BODY: Added overflow-x-hidden to prevent horizontal scroll bars */}
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        {/* Content Outlet - Scrollable Area */}
